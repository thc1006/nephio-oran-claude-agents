    ...
    <div className={containerClasses}>
      <div className={styles.header}>
        <h4 className={styles.title}>
          {variant === 'compact' ? 'Supported Versions' : 'Version Support Statement'}
        </h4>
        {showLastUpdated && (
      ...
      <div className={styles.content}>
        {variant === 'full' && (
          <p className={styles.description}>
            This documentation and the associated Claude agents are tested and supported 
            with the following canonical versions of O-RAN, Nephio, and related technologies.
          </p>
        )}
        ...
        {variant === 'full' && (
          <div className={styles.additionalInfo}>
            <div className={styles.note}>
              <strong>Note:</strong> While these are the canonical supported versions, 
              many agents may work with adjacent versions. Please refer to individual 
              agent documentation for specific compatibility requirements.
            </div>
            
            <div className={styles.policy}>
              <strong>Support Policy:</strong> We follow Kubernetes' support policy 
              of maintaining compatibility with the latest three minor releases.
            </div>
          </div>
        )}
      </div>
