...
async function runE2ETests() {
  ...
  try {
    ...
    try {
      ...
      console.warn(
        chalk.yellow('⚠️  Browser installation had issues, continuing...')
      );
    }
    ...
    const env = {
      ...
      BASE_URL:
        ...
        'http://localhost:3000/nephio-oran-claude-agents',
    ...
    await generateTestSummary(true);
    ...
    // Generate failure report and test summary
    await generateFailureReport(error);
    await generateTestSummary(false);
...
async function generateTestSummary(testsPassed = true) {
